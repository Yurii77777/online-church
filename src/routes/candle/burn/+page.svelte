...
<div class="relative flex flex-1 flex-col" style="min-height: 100vh;">
	...
	{#if showNudge}
		<div class="absolute bottom-16 left-0 right-0 z-10 text-center px-6 animate-[fadeIn_1.5s_ease-in-out]">
			...
			<div class="mt-1 flex flex-col items-center gap-1">
				<a href="{base}/candle#donate" class="font-body text-xs text-[var(--gold)]/30 hover:text-[var(--gold)]/60 transition-colors no-underline">
					Підтримати храм
				</a>
	...
	<div class="absolute bottom-0 left-0 right-0 z-10 pb-8 text-center px-6">
		<p class="font-display text-[var(--gold-light)]/60 text-lg tracking-widest">
			Свічка горить за {intention}
		</p>
	</div>
</div>
